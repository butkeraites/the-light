...
use the_light_core::reference::{book_number, format_reference};
use the_light_core::search::SearchOptions;
...
pub struct SearchArgs {
    ...
    #[arg(short, long, default_value_t = the_light_core::search::DEFAULT_LIMIT)]
    pub limit: usize,
