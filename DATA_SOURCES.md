...
- **EMBARCADA (ADR-0012, 2026-07-08):** **BSB (Berean Standard Bible)** — https://raw.githubusercontent.com/scrollmapper/bible_databases/master/formats/json/BSB.json — `public-domain`/`cc0` (domínio público desde 2023-04-30, berean.bible/licensing.htm), mesma shape scrollmapper, inglês moderno, 31.102 versículos. Registrada como 2ª versão EN (segue a KJV como primária); sem obrigação de atribuição. (Antes: alternativa documentada não escolhida.)
...
- **EMBARCADA (ADR-0012, 2026-07-08):** **Bíblia Livre (BLIVRE)** — https://github.com/damarals/biblias/releases/download/v1.0.0/BLIVRE.json — licença **`cc-by` (Brasil), atribuição OBRIGATÓRIA** (© Diego Santos, Mario Sérgio, Marco Teles). Português moderno, 31.102 versículos, mesma shape thiagobodruk. Registrada como 2ª versão PT (segue a ALM1911, que é PD puro). **ATENÇÃO: o mirror damarals rotula BLIVRE erradamente como "† domínio público" — isto é FALSO; os termos vinculantes upstream são CC BY 3.0 Brasil**, por isso o `SPEC` grava `license="cc-by"`. **Atribuição a exibir na app (verbatim, ADR-0012):** "Bíblia Livre (BLIVRE), © Diego Santos, Mario Sérgio e Marco Teles — CC-BY (Brasil), fonte: github.com/blivre/BibliaLivre". (Antes: alternativa documentada não escolhida.)
